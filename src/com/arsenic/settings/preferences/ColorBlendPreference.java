...
package com.arsenic.settings.preferences;
...
import net.margaritov.preference.colorpicker.NewColorPickerDialog;
...
public class ColorBlendPreference extends Preference
    ...
    private NewColorPickerDialog.OnColorChangedListener mStartColorChangedListener =
            new NewColorPickerDialog.OnColorChangedListener() {
                @Override
    ...
    private NewColorPickerDialog.OnColorChangedListener mEndColorChangedListener =
            new NewColorPickerDialog.OnColorChangedListener() {
                @Override
                public void onColorChanged(int color) {
    ...
    private void updateDialogSliderPreview() {
        ...
        mDialogPreviewColorBetween.setBackgroundColor(
                ArsenicUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private View.OnClickListener mDialogPreviewClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mDialogPreviewColorStart) {
                NewColorPickerDialog pickerDialog =
                        new NewColorPickerDialog(getContext(), mPreviewColorStart);
                pickerDialog.setOnColorChangedListener(mStartColorChangedListener);
                pickerDialog.show();
            } else if (v == mDialogPreviewColorEnd) {
                NewColorPickerDialog pickerDialog =
                        new NewColorPickerDialog(getContext(), mPreviewColorEnd);
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    ArsenicUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
