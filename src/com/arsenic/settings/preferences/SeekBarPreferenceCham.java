...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String ARSENICSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, ARSENICSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, ARSENICSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(ARSENICSETTINGSNS, "interval");
            if(newInterval != null)
