...
import com.arsenic.settings.preferences.MultiSelectListPreference;
...
public class AppCircleBar extends SettingsPreferenceFragment implements
    ...
    private MultiSelectListPreference mIncludedAppCircleBar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceScreen prefSet = getPreferenceScreen();
         ...
         int useAppCircle = Settings.System.getInt(resolver,
         ENABLE_APP_CIRCLE_BAR, 0);
         mUseAppCircle.setChecked(useAppCircle != 0);

        mIncludedAppCircleBar = (MultiSelectListPreference) prefSet.findPreference(PREF_INCLUDE_APP_CIRCLE_BAR_KEY);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mIncludedAppCircleBar) {
            ...
            ENABLE_APP_CIRCLE_BAR, value ? 1 : 0);
            return true;
        }
